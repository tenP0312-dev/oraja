...
/** CourseResult-compatible virtual state used only by Skin Select. */
final class SkinPreviewCourseResult extends CourseResult implements SkinPreviewState {
	SkinPreviewCourseResult(
